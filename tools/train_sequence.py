...
import argparse
from lib.engine.train_sequence import train_sequence
...
def main():
    ...
    train_sequence(cfg, logger=logger, model_dir=output_dir, local_rank=args.local_rank, distributed=args.distributed)
