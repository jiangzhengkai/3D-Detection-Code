...
def create_groundtruth_database(dataset_class_name,
    ...
    if 'nsweeps' in kwargs:
        dataset = get_dataset_class(dataset_class_name)(info_path=info_path, root_path=data_path, nsweeps=kwargs['nsweeps'])
    ...
    if dataset_class_name == 'NuScenesDataset':
        database_save_path = root_path / 'gt_database_10sweeps'
        db_info_save_path = root_path / "dbinfos_train_10sweeps.pkl"
    else:
