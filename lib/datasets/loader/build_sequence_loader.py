...
from lib.datasets.utils.preprocess import prep_sequence_pointcloud
from lib.datasets.loader.sampler import Sampler, DistributedSampler
from lib.datasets.all_dataset import get_dataset_class
from lib.datasets.utils.preprocess import collate_sequence_batch_fn
...
def build_sequence_dataloader(config, training, logger=None):
    ...
    dataloader = torch.utils.data.DataLoader(dataset,
                                             ...
                                             pin_memory=True,
                                             collate_fn=collate_sequence_batch_fn,
					     sampler=sampler)
    return dataloader
