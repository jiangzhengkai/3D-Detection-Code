...
def create_nuscenes_infos(root_path, version="v1.0-trainval", nsweeps=10):
    ...
    if test:
        ...
        with open(root_path / "infos_test_{:02d}sweeps_withvelo.pkl".format(nsweeps),
                  'wb') as f:
        ...
        with open(root_path / "infos_train_{:02d}sweeps_withvelo.pkl".format(nsweeps),
                  'wb') as f:
            pickle.dump(train_nusc_infos, f)
        with open(root_path / "infos_val_{:02d}sweeps_withvelo.pkl".format(nsweeps),
                  'wb') as f:
