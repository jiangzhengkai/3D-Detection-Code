...
class RoIFunction(Function):
    ...
    @staticmethod
    def forward(ctx, inputs, rois, pooled_height, pooled_width,
        ...
        output = RRoI.forward(inputs, rois, spatial_scale,
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = RRoI.backward(grad_output, rois, spatial_scale,
...
class RotateRoIAlign(nn.Module):
    ...
    def forward(self, inputs, rois):
        return RoIFunction.apply(inputs, rois, self.output_size[0], self.output_size[1],
