...
def correlation(input1,
                ...
                padding=0,
                dilation_patch=1):
    correlation_function = CorrelationFunction(kernel_size,
                                               patch_size,
                                               stride,
                                               padding,
                                               dilation_patch)
...
class CorrelationFunction(Function):
    ...
    def forward(self, input1, input2):
        ...
        output = correlation_cuda.forward(input1, input2,
                            kH, kW, patchH, patchW,
    ...
    def backward(self, grad_output):
        ...
        grad_input1, grad_input2 = correlation_cuda.backward(input1, input2, grad_output,
                                               kH, kW, patchH, patchW,
                                               padH, padW,
